package com.facd.soccernews.data;

import androidx.room.Room;

import com.facd.soccernews.App;
import com.facd.soccernews.data.local.SoccerNewsDb;
import com.facd.soccernews.data.remote.SoccerNewsApi;
...
public class SoccerNewsRepository {
    ...
    private static final String REMOTE_API_URL = " https://f3lp.github.io/soccer-news-api/";
